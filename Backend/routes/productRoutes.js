...
// GET all products with stock status for restock overview (must be before /:id)
router.get('/inventory-summary', authenticate, authorize('admin', 'staff'), productController.getInventorySummary);
